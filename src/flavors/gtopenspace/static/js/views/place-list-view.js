...
(function(S, $, console) {
  ...
  S.PlaceListView = Backbone.Marionette.CompositeView.extend({
    ...
    renderList: function() {
      ...
      // This is a little hacky...we're hiding the story bar content in the 
      // list view, which is being passed via rawTemplate to compileTemplate()
      $(".place-story-bar").css("display", "none");
    },
